...
financial_file = open('base_texts/f1.txt', 'r', encoding='utf-8')
hr_file = open('base_texts/h4.txt', 'r', encoding='utf-8')
law_file = open('base_texts/l1.txt', 'r', encoding='utf-8')
marketing_file = open('base_texts/m1.txt', 'r', encoding='utf-8')
...
print(save_vectors(sentences_lst[15:30], sentences_embeddings[15:30], 'найм'))
print(save_vectors(sentences_lst[30:45], sentences_embeddings[30:45], 'юриспруденция'))
print(save_vectors(sentences_lst[45:], sentences_embeddings[45:], 'маркетинг'))
